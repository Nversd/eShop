...
*/
  var addressid = $("#address_list .address_list").find("input[name='address_id']:checked").val();
  var now = new Date();
  Ajax.call('flow.php?step=select_shipping', 'shipping=' + obj.value+'&addressid='+addressid, orderShippingSelectedResponse, 'GET', 'JSON');
}
...
function checkOrderForm(frm)
{
  ...
  for (i = 0; i < frm.elements.length; i ++ )
  {
    ...
    if (frm.elements[i].name == 'address_id' && frm.elements[i].value!=0 && frm.elements[i].checked)
    {
