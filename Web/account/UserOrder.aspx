<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserOrder.aspx.cs" Inherits="account_UserOrder" %>
                ...
                <form runat="server">
                    <div class="all_main_a">
                        <div class="user_content">
                            ...
                            <h5><span style="color: #02a4a9">我的订单</span></h5>
                            <div class="blank"></div>
                            <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                                <thead>
                                    <tr align="center">
                                        <th height="35" bgcolor="#ffffff">订单号</th>
                                        <th bgcolor="#ffffff">下单时间</th>
                                        <th bgcolor="#ffffff">订单总金额</th>
                            ...
                            <div id="pager">
                                总计 <asp:Label runat="server" ID="totalCount"></asp:Label> 个记录，
                                共 <asp:Label runat="server" ID="totalPage"></asp:Label> 页。 
                                <span>
