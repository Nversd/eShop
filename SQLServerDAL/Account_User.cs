...
namespace EShop.SQLServerDAL
{
	...
	public partial class Account_User:IAccount_User
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "Account_User"); 
		}
		...
		public bool Exists(string UserCode,string AccountName,string Email,int Id)
		{
			...
			strSql.Append(" where UserCode=@UserCode and AccountName=@AccountName and Email=@Email and Id=@Id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,UserCode,AccountName,Email,Password,Status ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,UserCode,AccountName,Email,Password,Status ");
			strSql.Append(" FROM Account_User ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Account_User T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Account_User";
