...
namespace EShop.SQLServerDAL
{
	...
	public partial class Account_Coupon:IAccount_Coupon
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "Account_Coupon"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from Account_Coupon");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Account_Coupon ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,UserCode,CouponCode ");
			strSql.Append(" FROM Account_Coupon ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,UserCode,CouponCode ");
			strSql.Append(" FROM Account_Coupon ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Account_Coupon T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Account_Coupon";
